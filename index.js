        ...
        <div class="card p-4">
            ...
            justify-content-center align-items-center shadow product_image">
                ...
                <div class="col-md-7 col-11 mx-auto px-4 mt-2">
                    ...
                    <div class="row">
                    <div class="col-8 d-flex justify-content-between remove-item">
...
const discount_code = () => {
    ...
    else if (discountCode.value === 'FoodEats' && k == 0) {
        let productAmount = document.getElementById('productTotalAmount');
        let discount = document.getElementById('discount');
        temp = parseInt(productAmount.innerText);
        let discountAmount = temp / 5;
        discount.innerHTML = discountAmount.toFixed(2);
        errorThrow.innerHTML = "Hurray! Discound code is applied ";
        k = 1;
        updateCartTotal();
    } else {
        errorThrow.innerHTML = "Sorry, Code is invalid";
    }
}